  ...
  admin: () =>
    createSpecBuilder()
      .addComponent({
        ...
        props: { level: 2, text: 'Admin Control Panel' },
      })
      .addComponent({
        id: 'badge-role',
        componentType: 'StatusBadge',
        props: { text: 'Admin', status: 'error' },
      })
      .addComponent({
        id: 'text-intro',
        componentType: 'Text',
        props: { text: 'Full administrative access. All system controls and data management tools are visible.' },
      })
      .addComponent({
        id: 'metric-1',
        componentType: 'MetricCard',
        props: { label: 'Total Users', value: '45,231', trend: 'up' },
      })
      .addComponent({
        id: 'metric-2',
        componentType: 'MetricCard',
        props: { label: 'Revenue', value: '$128K', trend: 'up' },
      })
      .addComponent({
        id: 'table-1',
      ...
      .addComponent({
        ...
        props: { label: 'Reset All Sessions', variant: 'danger' },
      })
  ...
  editor: () =>
    createSpecBuilder()
      .addComponent({
        id: 'heading-1',
        componentType: 'Heading',
        props: { level: 2, text: 'Editor Workspace' },
      })
      .addComponent({
        id: 'badge-role',
        componentType: 'StatusBadge',
        props: { text: 'Editor', status: 'warning' },
      })
      .addComponent({
        id: 'text-intro',
        componentType: 'Text',
        props: { text: 'Content editing access. You can create and modify entries but cannot manage users or system settings.' },
      })
      .addComponent({
        id: 'card-drafts',
        componentType: 'Card',
      ...
      .addComponent({
        id: 'btn-new',
        componentType: 'Button',
        props: { label: 'New Draft', variant: 'primary' },
      })
      .withLayout({ type: 'stack', direction: 'vertical', spacing: 12 })
      .withMetadata({ model: 'mock-model' })
      .build(),
  ...
  viewer: () =>
    createSpecBuilder()
      .addComponent({
        id: 'heading-1',
        componentType: 'Heading',
        props: { level: 2, text: 'Viewer Dashboard' },
      })
      .addComponent({
        id: 'badge-role',
        componentType: 'StatusBadge',
        props: { text: 'Viewer', status: 'info' },
      })
      .addComponent({
        id: 'text-intro',
        componentType: 'Text',
        props: { text: 'Read-only access. You can view reports and published content. Editing controls are hidden.' },
      })
      .addComponent({
        id: 'card-reports',
        componentType: 'Card',
      ...
      .addComponent({
        id: 'text-notice',
        componentType: 'Text',
        props: { text: 'Contact an admin to request editing permissions.', variant: 'caption' },
      })
      .withLayout({ type: 'stack', direction: 'vertical', spacing: 12 })
      .withMetadata({ model: 'mock-model' })
      .build(),
